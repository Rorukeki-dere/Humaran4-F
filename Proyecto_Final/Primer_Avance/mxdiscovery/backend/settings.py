...
import os,sys #Python proporcina una interfaz que interactua con el sistema operativo
from dotenv import load_dotenv #permite la carga de variables de entorno .env


load_dotenv() #se llama la funcion
...
SECRET_KEY = os.environ.get("SECRET_KEY") #anade seguiridad a la aplicacion, sin ella, la app no ejecuta
...
sys.path.append('/home/jose/workspace/proyectomxv2/mxdiscovery/')
...
#Este codigo, nos permite generar una autenticacion a los usuarios
#mediante JSON Web Tokens (JWS)
