  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="container mx-auto">
        <div className="mx-auto w-full max-w-screen-x12">
            ...
            <div className="flex justify-center md:col-span-2">
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  ...
                  <li className="mb-4">
                    <a href="https://www.youtube.com/@MXDiscovery" className="hover:underline">
                      Youtube
                    </a>
                  </li>
                </ul>
          ...
          <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
              ...
              <a
                href="https://www.facebook.com/mx.discovery"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
              ...
              <a
                href="https://github.com/finalejd/proyectomxdiscovery"
                className="text-gray-400 hover:text-gray-900 dark:hover:text-white"
              >
                <svg
                  className="w-4 h-4"
